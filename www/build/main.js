...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(4), __webpack_require__(13), __webpack_require__(6), __webpack_require__(7)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    } else if (typeof exports !== "undefined") {
    ...
    var AllModal = exports.AllModal = function () {
        ...
        _createClass(AllModal, [{
            ...
            value: function creatModal(params, dom) {
                ...
                var subh = params.subh || "";
                var ok = params.ok || '确定';
                var cancel = params.cancel || "取消";
                var name = params.name || "";
                var ok_btn = params.ok_btn || "";
                var cancel_btn = params.cancel_btn || "";
                var dom_box = '<div class="modal_box' + ' ' + name + '"><div class="modal_box_ct"><div class="mbc_hd"><h2>' + title + '</h2>' + subh + '<span class="m_frs m_cls' + ' ' + cancel_btn + '">×</span></div>' + '<div class="modal_box_inc_val">' + dom + '</div>' + '<div class="mbc_hd"><div class="mbc_ok' + ' ' + ok_btn + '">' + ok + '</div><div class="mbc_cancel m_cls' + ' ' + cancel_btn + '">' + cancel + '</div></div></div></div>';
                return dom_box;
            }
        }]);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(14), __webpack_require__(15), __webpack_require__(4), __webpack_require__(16), __webpack_require__(5), __webpack_require__(17)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    } else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    if (true) {
        ...
        factory(exports, require('jquery'), require('./navCtrl.js'), require('./bannerCtrl.js'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.jquery, global.navCtrl, global.bannerCtrl);
        global.tool = mod.exports;
    }
})(this, function (exports, _jquery, _navCtrl, _bannerCtrl) {
    'use strict';
    ...
    var TOOL = exports.TOOL = function () {
        ...
        _createClass(TOOL, [{
            ...
            value: function _MouseOverEvent(dom, same) {
                ...
                (0, _jquery2.default)('.ctrl_tools').off('mouseleave');
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    if (true) {
        ...
        factory(exports, require('jquery'), require('./modalCtrl.js'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.jquery, global.modalCtrl);
        global.navCtrl = mod.exports;
    }
})(this, function (exports, _jquery, _modalCtrl) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.NavTotalModal = undefined;
    ...
    var NavTotalModal = exports.NavTotalModal = function (_AllModal) {
        ...
        function NavTotalModal() {
            ...
            return _possibleConstructorReturn(this, (NavTotalModal.__proto__ || Object.getPrototypeOf(NavTotalModal)).apply(this, arguments));
        }

        _createClass(NavTotalModal, [{
            key: 'hmtotalMouse',
            ...
            key: 'modalTotal',
            value: function modalTotal(params) {
                var all_Mname = '.modal_box'; //总modla的class名
                var p_dom = params.modal.dom;
                var ta = (0, _jquery2.default)(p_dom).find("a");
                var modal = this._centerModal(ta); //构建内置dom
                var dom = modal || '';
                //构建dom
                this._remove(all_Mname);
                this._create(params, dom);
                //编辑事件
                this._okModal('.mbc_ok', all_Mname);
                this._cancelModal('.m_cls', all_Mname);
                this._moveModal('.md_down', 'down');
                this._moveModal('.md_up', 'up');
                this._removeModal('.md_nav_remove');
                this._editModal('.md_nav_edit');
                this._isHiddenModal('.mbc_item_opti');
                this._addModal('.md_add_ct');
            }
            //初始化整个DOM

        }, {
            key: '_create',
            value: function _create(params, dom) {
                var dom_box = _get(NavTotalModal.prototype.__proto__ || Object.getPrototypeOf(NavTotalModal.prototype), 'creatModal', this).call(this, params, dom);
                (0, _jquery2.default)('body').append(dom_box);
            }
            //删除整个DOM
            ...
            value: function _foreachModal(dom) {
                ...
                for (var i = 0; i < dom.length; ++i) {
                    var lt_dom = (0, _jquery2.default)(dom).eq(i);
                    var d_rm = "";
                    var class_name = "";
                    var j = lt_dom.attr('nav-cid');
                    var xatt = lt_dom.attr('ishp');
                    var ahref = lt_dom.attr('href');
                    var d_opti = "";
                    lt_dom.css('display') == 'none' ? class_name = 'mb_opoff' : class_name = 'mb_opon';
                    if (xatt == 'true') {
                        d_rm = "";
                        d_opti = "";
                    } else {
                        d_rm = '<a href="javascript:;" class="md_nav_remove">[删除]</a>';
                        d_opti = '<li class="col-30 mbc_item_opti' + ' ' + class_name + '"></li>';
                    }
                    str += '<ul class="mbc_item" nav_cid="' + [j] + '"><li class="col-30"><span data-url="' + ahref + '" class="nav_html">' + lt_dom.html() + '</span><a href="javascript:;" class="md_arrow md_up"></a>' + '<a href="javascript:;" class="md_arrow md_down"></a></li>' + d_opti + '<li class="col-30 f-p-r"><a href="javascript:;" class="md_nav_edit">[编辑]</a>' + d_rm + '</li></ul>';
                }
                return str;
            }
            //确定事件
            ...
            key: '_okModal',
            value: function _okModal(cname, allM) {
                var _this3 = this;

                (0, _jquery2.default)(cname).on('click', function () {
                    _this3._remove(allM);
                });
            }
            //取消事件
            ...
            key: '_cancelModal',
            value: function _cancelModal(cname, allM) {
                var _this4 = this;

                (0, _jquery2.default)(cname).on('click', function () {
                    var conf = confirm("您的修改将不会保存");
                    conf == true ? _this4._remove(allM) : "";
                });
            }
            //移动当前DOM
            ...
            key: '_moveModal',
            value: function _moveModal(dom, opera) {
                // var cur_d = $('.mbc_item');
                (0, _jquery2.default)(dom).off('click');
                click_event(opera);
                function click_event(type) {
                    (0, _jquery2.default)(dom).on('click', function (e) {
                        var dos = (0, _jquery2.default)(e.toElement).parent().parent();
                        var dos_n = "";
                        type == 'up' ? dos_n = dos.prev() : dos_n = dos.next();
                        dos_n.length != 0 ? type == 'up' ? dos_n.before(dos) : dos_n.after(dos) : '';
                    });
                }
            }
            //编辑当前DOM
            ...
            key: '_editModal',
            value: function _editModal(cname) {
                var _this5 = this;

                var modal_name = '.navEdit';
                this._remove(modal_name);
                var dom = '<div class="nav_edit_box"><div class="list-item"><span>栏目名称:</span><input type="text" class="nav_edit_input" placeholder="输入栏目名称" value=""> </div>' + '<div class="list-item"><span>链接类型:</span><select class="nav_edit_select"><option value ="默认">默认链接</option><option value ="自定义">自定义链接</option></select></div>' + '<div class="list-item nav_edit_add nav_edit_swip"><span>自定义地址:</span><input type="text" class="nav_edit_input" placeholder="输入路由地址" value=""></div>' + '<div class="list-item"><input type="checkbox" class="nav_edit_check" />在新页面打开</div></div>';
                var params = {
                    title: '操作提示',
                    name: 'navEdit',
                    ok_btn: 'navOk',
                    cancel_btn: 'navCancel'
                };
                (0, _jquery2.default)(cname).off('click');
                (0, _jquery2.default)(cname).on('click', function (e) {
                    _this5._create(params, dom);
                    var dos = (0, _jquery2.default)(e.toElement).parent().parent();
                    var chr = dos.children().children('.nav_html');
                    var title = (0, _jquery2.default)('.nav_edit_input'); //获取输入框
                    var check = (0, _jquery2.default)('.nav_edit_check'); //获取check按钮
                    //初始化三个input的值
                    title.eq(0).val(chr.html());
                    title.eq(1).val(chr.attr('data-url'));
                    chr.attr('target') == '_blank' ? check.attr('checked', true) : '';
                    //下拉事件
                    (0, _jquery2.default)('.nav_edit_select').off('change');
                    (0, _jquery2.default)('.nav_edit_select').on('change', function () {
                        var p_dom = (0, _jquery2.default)('.nav_edit_select');
                        p_dom[0].value == '自定义' ? (0, _jquery2.default)('.nav_edit_add').removeClass("nav_edit_swip") : (0, _jquery2.default)('.nav_edit_add').addClass("nav_edit_swip");
                    });
                    //确定和取消按钮
                    (0, _jquery2.default)('.navOk').off('click');
                    (0, _jquery2.default)('.navOk').on('click', function () {
                        var txh = title.eq(0).val();
                        var dxh = title.eq(1).val();
                        chr.html() == txh ? "" : chr.html(txh);
                        chr.attr('data-url') == dxh ? "" : chr.attr('data-url', dxh);
                        var ischeck = check.is(':checked');
                        ischeck == true ? chr.attr('target', '_blank') : chr.attr('target', '_self');
                        _this5._remove(modal_name);
                    });
                    (0, _jquery2.default)('.navCancel').off('click');
                    (0, _jquery2.default)('.navCancel').on('click', function () {
                        var conf = confirm("您的修改将不会保存");
                        conf == true ? _this5._remove(modal_name) : "";
                    });
                });
            }
            //删除当前DOM
            ...
            key: '_removeModal',
            value: function _removeModal(cname) {
                var _this6 = this;

                var modal_name = '.navRemove';
                this._remove(modal_name);
                var dom = '<p>确定要删除这个栏目？</p>';
                var params = {
                    title: '操作提示',
                    name: 'navRemove',
                    ok_btn: 'navOk',
                ...
                (0, _jquery2.default)(cname).off('click');
                (0, _jquery2.default)(cname).on('click', function (e) {
                    _this6._create(params, dom);
                    (0, _jquery2.default)('.navOk').off('click');
                    (0, _jquery2.default)('.navOk').on('click', function () {
                        var dos = (0, _jquery2.default)(e.toElement).parent().parent();
                        (0, _jquery2.default)(dos).remove();
                        _this6._remove(modal_name);
                    });
                    (0, _jquery2.default)('.navCancel').off('click');
                    (0, _jquery2.default)('.navCancel').on('click', function () {
                        _this6._remove(modal_name);
            ...
            */
            ...
            key: '_isHiddenModal',
            value: function _isHiddenModal(cname) {
                (0, _jquery2.default)(cname).off('click');
                (0, _jquery2.default)(cname).on('click', function (e) {
                    var t_dom = (0, _jquery2.default)(e.toElement);
                    t_dom.hasClass("mb_opon") == true ? t_dom.removeClass("mb_opon").addClass("mb_opoff") : t_dom.removeClass("mb_opoff").addClass("mb_opon");
                });
            }
            ...
            key: '_addModal',
            value: function _addModal(cname) {
                var _this7 = this;

                var modal_name = '.navAdd';
                this._remove(modal_name);
                var dom = '<div class="nav_edit_box"><div class="list-item"><span>栏目名称:</span><input type="text" class="nav_edit_input" placeholder="输入栏目名称" value=""> </div>' + '<div class="list-item nav_edit_add"><span>自定义地址:</span><input type="text" class="nav_edit_input" placeholder="输入路由地址" value=""></div>' + '<div class="list-item"><input type="checkbox" class="nav_edit_check" />在新页面打开</div></div>';
                var params = {
                    title: '新增栏目',
                    name: 'navAdd',
                    ok_btn: 'navOk',
                ...
                (0, _jquery2.default)(cname).on('click', function (e) {
                    ...
                    (0, _jquery2.default)('.navOk').on('click', function () {
                        ...
                        var ischeck = check.is(':checked');
                        ischeck == true ? chr.attr('target', '_blank') : chr.attr('target', '_self');
                        _this7._remove(modal_name);
                    });
                    (0, _jquery2.default)('.navCancel').off('click');
                    (0, _jquery2.default)('.navCancel').on('click', function () {
                        var conf = confirm("您的修改将不会保存");
                        conf == true ? _this7._remove(modal_name) : "";
                    });
                });
            }
        }]);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    ...
    exports.BannerTotalModal = undefined;
    ...
    var BannerTotalModal = exports.BannerTotalModal = function (_AllModal) {
        ...
        function BannerTotalModal() {
            ...
            return _possibleConstructorReturn(this, (BannerTotalModal.__proto__ || Object.getPrototypeOf(BannerTotalModal)).apply(this, arguments));
        }

        _createClass(BannerTotalModal, [{
            key: 'hmtotalMouse',
            ...
            value: function hmtotalMouse(dom, wh, ht) {
                ...
                var left = Math.floor(wh.left);
                var ht = Math.floor(ht);
                var tag = '<ul class="hm_nav_tl"><li class="hm_li_clnm">编辑横幅</li><li>更换模板</li><li>隐藏</li></ul>';
                (0, _jquery2.default)('.tools').html(tag);
                (0, _jquery2.default)('.ctrl_tools').css({ 'top': ht, 'left': left });
                (0, _jquery2.default)('.hm_li_clnm').on('click', function () {
                    var params = {
                        modal: {
                            title: '编辑横幅',
                            subh: '<span class="hb_subh">(建议上传宽高为xxx的图片)</span>',
                            name: 'bannerTotal',
                            dom: dom
                        }
                    };
            ...
            value: function modalTotal(params) {
                ...
                this._create(params, dom);
                //确认取消事件
                this._okModal('.mbc_ok', all_Mname, p_dom, ta);
                this._cancelModal('.m_cls', all_Mname);
                //控制
                this._allCtrl();
            }
            ...
            key: '_create',
            value: function _create(params, dom) {
                var dom_box = _get(BannerTotalModal.prototype.__proto__ || Object.getPrototypeOf(BannerTotalModal.prototype), 'creatModal', this).call(this, params, dom);
                (0, _jquery2.default)('body').append(dom_box);
            }
            //删除整个DOM
            ...
            value: function _centerModal(params) {
                var dom = params || '';
                var fetch = this._foreachModal(dom);
                var domx = '<div class="md_hbanner_box"><ul class="md_sl_menu"><li><a class="sl_m_a sl_m_active" href="javascript:;">常规</a></li></ul>' + '<div class="rule_setting"><div class="list-item list-bg-gy"><div class="col-25">图片</div><div class="col-25">链接</div><div class="col-25">排序</div><div class="col-25">操作</div></div><div class="md_sl_box">' + fetch + '</div><div class="hbanner_add"><span>+添加横幅</span></div><input type="file" id="file" accept="image/*" style="display:none"></div></div>';
                return domx;
            }
            //循环构建dom
            ...
            value: function _foreachModal(dom) {
                ...
                while (i < dom.length) {
                    var lt_dom = (0, _jquery2.default)(dom).eq(i);
                    var ahref = lt_dom.attr('href') || '无';
                    ahref == 'javascript:;' || ahref == '#' ? ahref = "无" : '';
                    var imgSrc = lt_dom.children().attr('src');
                    str += '<div class="list-item list-dv-ct"><div class="col-25">' + '<img class="hb_attrimg" src="' + imgSrc + '" alt="背景图"></div>' + '<div class="col-25"><span class="hb_attrurl">' + ahref + '</span></div><div class="col-25"><a href="javascript:;" class="md_arrow md_up"></a><a href="javascript:;" class="md_arrow md_down"></a></div>' + '<div class="col-25"><div class="hb_edit_icon"></div><div class="hb_delete_icon"></div></div></div>';
                    ++i;
                }
                return str;
            }
            ...
            key: '_allCtrl',
            value: function _allCtrl() {
                this._moveModal('.md_down', 'down');
                this._moveModal('.md_up', 'up');
                this._removeModal('.hb_delete_icon');
                this._editModal('.hb_edit_icon');
                this._addModal('.hbanner_add');
            }
            //确定事件

        }, {
            key: '_okModal',
            value: function _okModal(cname, allM, p_dom) {
                var _this3 = this;

                (0, _jquery2.default)(cname).on('click', function () {
                    var imgSrc = (0, _jquery2.default)('.hb_attrimg');
                    var attrUrl = (0, _jquery2.default)('.hb_attrurl');
                    var i = 0;
                    var len = imgSrc.length;
                    var a_dom = a_dom = (0, _jquery2.default)(p_dom)[0].getElementsByTagName('a');
                    var pd_dom = (0, _jquery2.default)(a_dom[i]).parent().parent();
                    var plen = a_dom.length;
                    var str = "";
                    if (plen > len) {
                        var j = 0;
                        while (j < plen) {
                            j > len - 1 ? (0, _jquery2.default)(a_dom[j]).parent().remove() : "";
                            ++j;
                        }
                    }
                    while (i < len) {
                        var url = attrUrl.eq(i).html();
                        var src = imgSrc.eq(i).attr('src');
                        if (i > a_dom.length - 1) {
                            var p_tdom = (0, _jquery2.default)(a_dom[i - 1]).parent().clone();
                            a_dom[i] = p_tdom.children();
                        }
                        url == '无' ? (0, _jquery2.default)(a_dom[i]).attr('href', 'javascript:;') : url != (0, _jquery2.default)(a_dom[i]).attr('href') ? (0, _jquery2.default)(a_dom[i]).attr('href', url) : '';
                        src != (0, _jquery2.default)(a_dom[i]).children().attr('src') ? (0, _jquery2.default)(a_dom[i]).children().attr('src', src) : '';
                        i > a_dom.length - 1 ? str += (0, _jquery2.default)(a_dom[i]).parent()[0].outerHTML : '';
                        ++i;
                    }
                    len > plen ? (0, _jquery2.default)(pd_dom).append(str) : "";
                    _this3._remove(allM);
                });
            }
            //取消事件
            ...
            value: function _editModal(cname) {
                ...
                var modal_name = '.navEdit';
                this._remove(modal_name);
                var dom = '<div class="hb_slide_sd"><div class="hb_slide_sdbx"><img class="hb_eimg" src="" alt="背景图"></div>' + '<div class="list-item"><span>跳转方式:</span>' + '<input type="radio" name="skip" class="hb_nskip" value="不跳转">不跳转' + '<input type="radio" name="skip" class="hb_skip" value="跳转">跳转</div>' + '<div class="list-item"><span>链接地址</span><input class="banner_edit_input"  type="text"></div>' + '<div class="list-item"><span>横幅文件</span><a class="banner_dwn" href="" download="下载">点击下载</a></div></div>';
                var params = {
                    title: '编辑横幅',
                    name: 'navEdit',
                    ok_btn: 'navOk',
                ...
                (0, _jquery2.default)(cname).on('click', function (e) {
                    _this5._create(params, dom);
                    var dos = (0, _jquery2.default)(e.toElement).parent().parent();
                    var chr = dos.children().children('.hb_attrimg');
                    var attr = dos.children().children('.hb_attrurl');
                    var title = (0, _jquery2.default)('.banner_edit_input'); //获取输入框
                    var imgSrc = (0, _jquery2.default)('.hb_eimg'); //获取img位置
                    var radion = (0, _jquery2.default)('.hb_nskip'); //获取radio值
                    var radioy = (0, _jquery2.default)('.hb_skip'); //获取radio值
                    var down = (0, _jquery2.default)('.banner_dwn');
                    //初始化值
                    imgSrc.attr('src', chr.attr('src'));
                    down.attr('href', chr.attr('src'));
                    if (attr.html() && attr.html() != '#' && attr.html() != 'javascript:;' && attr.html() != '无') {
                        title.eq(0).val(attr.html());
                        radioy.attr('checked', true);
                        title.parent().css('display', 'block');
                    } else {
                        radion.attr('checked', true);
                        title.parent().css('display', 'none');
                    }
                    //radio触发事件
                    (0, _jquery2.default)('input:radio[name="skip"]').change(function (e) {
                        var val = (0, _jquery2.default)(e.target).val();
                        val == '不跳转' ? title.parent().css('display', 'none') : title.parent().css('display', 'block');
                    });
                    //确定和取消按钮
                    (0, _jquery2.default)('.navOk').off('click');
                    (0, _jquery2.default)('.navOk').on('click', function () {
                        var val = (0, _jquery2.default)('input:radio[name="skip"]:checked').val();
                        if (val == '跳转') {
                            attr.html(title.eq(0).val());
                        } else {
                            attr.html('无');
                        }
                        _this5._remove(modal_name);
            ...
            value: function _addModal(cname) {
                ...
                //头像上传     
                var dom = (0, _jquery2.default)(cname);
                var file = document.getElementById("file");
                var domb = (0, _jquery2.default)('.md_sl_box');
                dom.off('click');
                dom.on('click', function () {
                    ...
                    file.onchange = function () {
                        ...
                        reader.onload = function (evt) {
                            var imgUrl = evt.target;
                            var base64 = imgUrl.result;
                            var add_dom = '<div class="list-item list-dv-ct"><div class="col-25">' + '<img class="hb_attrimg" src="' + base64 + '" alt="背景图"></div>' + '<div class="col-25"><span class="hb_attrurl">' + '无' + '</span></div><div class="col-25"><a href="javascript:;" class="md_arrow md_up"></a><a href="javascript:;" class="md_arrow md_down"></a></div>' + '<div class="col-25"><div class="hb_edit_icon"></div><div class="hb_delete_icon"></div></div></div>';
                            domb.append(add_dom);
                            _this7._allCtrl();
                        };
